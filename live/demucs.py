...
def deserialize_demucs(package):
    """
    Deserialize demucs model.
    """
    klass = package['class']
...
def get_demucs(args):
    ...
    """
    print("Loading model from {1}".format(args.model_path))
    ...
    length = streamer.stride

    def feed(args, signal):
...
# Below taken from demucs implementation:
# Credit: https://github.com/facebookresearch/denoiser
